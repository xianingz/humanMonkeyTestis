...
```{r}
for(i in intersect(markers, humMacMouOrth.1to1.in$external_gene_name.x)){
  pdf(paste0("/home/xianingz/storage/HumanMacaqueMouseCompAnaysis/interdata/SPG_markers/violin/hum_",i,".pdf"),width = 2.5, height = 2.5)
  p<-VlnPlot(object = spg.cca.hum, features.plot = i,group.by = "res.0.6.ord",point.size.use=0, ident.include = c(1:6),cols.use = cols)
  print(p)
  dev.off()
  
  pdf(paste0("/home/xianingz/storage/HumanMacaqueMouseCompAnaysis/interdata/SPG_markers/violin/mac_",i,".pdf"),width = 2.5, height = 2.5)
  p<-VlnPlot(object = spg.cca.mac, features.plot = i,group.by = "res.0.6.ord",point.size.use=0, ident.include = c(1:6),cols.use = cols)
  print(p)
  dev.off()
  
  pdf(paste0("/home/xianingz/storage/HumanMacaqueMouseCompAnaysis/interdata/SPG_markers/violin/mou_",i,".pdf"),width = 2.5, height = 2.5)

...
p <- vlnplot_gg(spg.cca.hum, i, adjust = 2)
print(p)
dev.off()
...
p <- vlnplot_gg(spg.cca.mac, i, adjust = 2)
print(p)
dev.off()
...
p <- vlnplot_gg(spg.cca.mou, i, adjust = 2)
print(p)
dev.off()
}
```
...
```{r}
markers <- c("GFRA1","ZBTB16","LIN28A","ID4","ITGA6","UCHL1","STRA8","MKI67","DMRT1","SYCP2","HORMAD1","MEIOB","LY6K","TEX101","PIWIL4","MORC1","TCF3","CDK17","FMR1","L1TD1")
for(i in markers){
jpeg(paste0("~/storage/HumanMacaqueMouseCompAnaysis/interdata/SPG_markers/violin/Mouse.spg.cca","_",i,"_violin.jpeg"),height=850,width=800,res=300)

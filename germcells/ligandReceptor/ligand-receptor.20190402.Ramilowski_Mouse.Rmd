...
```{r eval=FALSE}
int.plot(lig.rec.germ.soma, lig.mean = germ.mean, rec.mean = soma.mean, lig.lab = germ.lab, rec.lab = soma.lab, lig.label = "SPG", rec.label = "Soma",lineup = c(14,4), perc=0.2,filename="~/storage/HumanMacaqueMouseCompAnaysis/ligandReceptor/20190402_SPG_Soma/mouse/lig.rec.germ.soma.20per.pdf")
int.plot(lig.rec.soma.germ, lig.mean = soma.mean, rec.mean = germ.mean, lig.lab = soma.lab, rec.lab = germ.lab, lig.label = "Soma", rec.label = "SPG",lineup = c(15,4), perc=0.2,filename="~/storage/HumanMacaqueMouseCompAnaysis/ligandReceptor/20190402_SPG_Soma/mouse/lig.rec.soma.germ.20per.pdf")
...
int.plot(lig.rec.germ.germ, lig.mean = germ.mean, rec.mean = germ.mean, lig.lab = germ.lab, rec.lab = germ.lab, lig.label = "SPG", rec.label = "SPG",lineup = c(3,4), perc=0.2,filename="~/storage/HumanMacaqueMouseCompAnaysis/ligandReceptor/20190402_SPG_Soma/mouse/lig.rec.germ.germ.20per.pdf")
```